...
<head>
    <meta charset="UTF-8" />
    <title>Recuperar contraseña - FileHub</title>
                            ...
                            <div class="col-lg-12">
                                <div class="card-body p-md-5 mx-md-4">
                                    ...
                                    <a href="../index.php"><img src="../images/LOGO_250x250.png" style="width: 185px;" alt="logo"></a>
                                        ...
                                        <p>Por favor, introduce tu dirección de email, si esta coincide con alguna registrada, enviaremos un email con la nueva contraseña.</p>
                                    </div>
                                    <form method="POST" action="../controllers/sendRecoverPassword_controller.php">
